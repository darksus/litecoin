...
VERSION=
commit=false
url=https://github.com/testcoin-project/testcoin
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the testcoin, gitian-builder, gitian.sigs.ltc, and testcoin-detached-sigs.
