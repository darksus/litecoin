...
* Update manpages, see [gen-manpages.sh](https://github.com/testcoin-project/testcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Announce the release:
  ...
  - testcoin-dev and testcoin-dev mailing list

  - blog.testcoin.org blog post

  - Update title of #testcoin and #testcoin-dev on Freenode IRC
