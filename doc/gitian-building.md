...
Output from `gbuild` will look something like
    ...
    From https://github.com/testcoin-project/testcoin
...
For example:
```bash
URL=https://github.com/thrasher-/testcoin.git
...
BTCPATH=/some/root/path/testcoin
SIGPATH=/some/root/path/testcoin-detached-sigs

./bin/gbuild --url testcoin=${BTCPATH},signature=${SIGPATH} ../testcoin/contrib/gitian-descriptors/gitian-win-signer.yml
```
...
[testcoin-project/gitian.sigs.ltc](https://github.com/testcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
